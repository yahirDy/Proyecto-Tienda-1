...
public class GraficaBarrasEmpleadoEdad extends javax.swing.JPanel {
    private GUI.daoEmpleado daoEmpleado;
    private ArrayList<String> noms = new ArrayList();
    private ArrayList<Integer> eds = new ArrayList();
    private ArrayList<String> ape = new ArrayList();
    
    private ArrayList<Integer> array;
    private boolean isSorting;
    
    public GraficaBarrasEmpleadoEdad(){
    ...
    isSorting = false;
        ...
        super.paintComponent(g);
                ...
                int barWidth = getWidth() / eds.size();
                int maxCantidad = getMaxValue(eds);

                for (int i = 0; i < eds.size(); i++) {
                    int barHeight = (int) (((double) eds.get(i) / maxCantidad) * (getHeight() - 50));
                    int x = i * barWidth;
            ...
            for (Integer ed : eds) {
                ...
                g.fillRect(x, y, barWidth, barHeight);
                    ...
                    g.drawString("Edad:", x, getHeight() - 20);
                    g.drawString(String.valueOf(eds.get(i)), x, getHeight() - 5);
                }
            }
